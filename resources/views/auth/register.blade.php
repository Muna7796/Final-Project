...
<body>
  <nav class="navbar navbar-dark navbar-fixed-top" style="background-color:#940808;">
    <div class="container">
      <div class="navbar-header">
        <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#myNavbar">
          <i class="fa fa-bars"></i>
        </button>
        <a class="navbar-brand" href="https://codepen.io/Mamik153/full/MXOyjY/">Rakt Seva</a>
      </div>
