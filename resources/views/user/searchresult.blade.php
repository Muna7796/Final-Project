                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <select class="form-control" name="province" required>
                                                ...
                                                <option value="Madesh Province" @if($request->get('province') == 'Madesh Province') selected @endif >Madesh Province</option>
                                                <option value="Bagmati Province" @if($request->get('province') == 'Bagmati Province') selected @endif >Bagmati Province</option>
                                                <option value="Gandaki Province" @if($request->get('province') == 'Gandaki Province') selected @endif >Gandaki Province</option>
                                                <option value="Lumbeni Province" @if($request->get('province') == 'Lumbeni Province') selected @endif >Lumbeni Province</option>
                                                <option value="Karnali Province" @if($request->get('province') == 'Karnali Province') selected @endif >Karnali Province</option>
                                                <option value="Sudurpashchim Province" @if($request->get('province') == 'Sudurpashchim Province') selected @endif >Sudurpashchim Province</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <select id="blood_group" class="form-control" name="bloodgroup"  required>
                                                <option value="A+" @if($request->get('bloodgroup')=='A+') selected @endif >A+</option>
                                                <option value="B+" @if($request->get('bloodgroup')=='B+') selected @endif >B+</option>
                                                <option value="O+" @if($request->get('bloodgroup')=='O+') selected @endif >O+</option>
                                                <option value="O-" @if($request->get('bloodgroup')=='O-') selected @endif >O-</option>
                                                <option value="AB+" @if($request->get('bloodgroup')=='AB+') selected @endif >AB+</option>
                                                <option value="AB-" @if($request->get('bloodgroup')=='AB-') selected @endif >AB-</option>
                                                <option value="A-" @if($request->get('bloodgroup')=='A-') selected @endif >A-</option>
                                                <option value="B-" @if($request->get('bloodgroup')=='B-') selected @endif >B-</option>
                                            </select>
